...
import static ru.netology.web.data.data.DataHelper.*;
...
public class MoneyTransferTest {
    ...
    @BeforeEach
    void setup() {
        var loginPaige = open("http://localhost:9999", LoginPage.class);
        var authInfo = getAuthInfo();
        var verificationPage = loginPaige.validLogin(authInfo);
    ...
    void shouldGetErrorMessageIfAmountMoreBalance() {
        ...
        var actualBalanceFirstCard = dashboardPage.getCardBalance(firstCardInfo);
        var actualBalanceSecondCard = dashboardPage.getCardBalance(secondCardInfo);
        assertEquals(firsCardBalance, actualBalanceFirstCard);
